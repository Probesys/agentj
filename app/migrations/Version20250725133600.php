...
final class Version20250725133600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            ALTER TABLE domain
            CHANGE send_user_alerts send_user_alerts TINYINT(1) NOT NULL,
            CHANGE send_user_mail_alerts send_user_mail_alerts TINYINT(1) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE out_msgs
            CHANGE processed_user processed_user TINYINT(1) NOT NULL,
            CHANGE processed_admin processed_admin TINYINT(1) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            ALTER TABLE out_msgs
            CHANGE processed_user processed_user TINYINT(1) DEFAULT 0 NOT NULL,
            CHANGE processed_admin processed_admin TINYINT(1) DEFAULT 0 NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
