...
final class Version20260610152403 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add columns to track async tasks results';
    }
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(<<<SQL
            ...
            ADD last_success_result LONGTEXT DEFAULT '{}' NOT NULL,
