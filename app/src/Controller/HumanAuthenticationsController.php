...
use App\Service\HumanAuthenticationsService;
...
class HumanAuthenticationsController extends AbstractController
{
    ...
    public function show(
        ...
        HumanAuthenticationsService $humanAuthenticationsService,
        TranslatorInterface $translator,
    ): Response {
        list($message, $domain, $messageRecipients) = $humanAuthenticationsService->decryptToken($token);
