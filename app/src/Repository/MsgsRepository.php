...
class MsgsRepository extends ServiceEntityRepository {
   ...
   * @return string
   */
  private function getSearchMsgSqlWhere(User $user = null, $type = null, $alias = array(), $fromDate = null) {
    $email = null;
   ...
   * @return int
   */
  public function countByType(User $user = null, $type = null, $alias = array()) {
   ...
   * @return int
   */
  public function countByTypeAndDays(User $user = null, $type = null, $alias = array()) {
    $conn = $this->getEntityManager()->getConnection();
    $conn->getConfiguration()->getSQLLogger(null);
   ...
   * @return type
   */
  public function search(User $user = null, $type = null, $alias = array(), $searchKey = null, $sortPrams = null, $fromDate) {
